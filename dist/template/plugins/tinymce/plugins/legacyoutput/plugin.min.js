    ...
    return a.add("legacyoutput", function (a, c, d) {
      a.settings.inline_styles = !1, a.on("init", function () {
        ...
        var b = [],
            ...
            d = a.settings.fontsizeFormats || c;return a.$.each(d.split(" "), function (a, c) {
          var d = c,
              e = c,
              f = c.split("=");f.length > 1 && (d = f[0], e = f[1]), b.push({ text: d, value: e });
        }), { type: "listbox", text: "Font Sizes", tooltip: "Font Sizes", values: b, fixedWidth: !0, onPostRender: function onPostRender() {
            var b = this;a.on("NodeChange", function () {
              var c;c = a.dom.getParent(a.selection.getNode(), "font"), c ? b.value(c.size) : b.value("");
            });
        ...
        function b(a) {
          a = a.replace(/;$/, "").split(";");for (var b = a.length; b--;) {
            ...
            e = [],
            f = b(a.settings.font_formats || c);return d.each(f, function (a, b) {
          e.push({ text: { raw: b[0] }, value: b[1], textStyle: b[1].indexOf("dings") == -1 ? "font-family:" + b[1] : "" });
        }), { type: "listbox", text: "Font Family", tooltip: "Font Family", values: e, fixedWidth: !0, onPostRender: function onPostRender() {
            var b = this;a.on("NodeChange", function () {
              var c;c = a.dom.getParent(a.selection.getNode(), "font"), c ? b.value(c.face) : b.value("");
            });
