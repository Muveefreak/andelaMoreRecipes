  ...
  var a = {},
    ...
    return a.add("directionality", function (a) {
      function c(c) {
        var d,
            e = a.dom,
            f = a.selection.getSelectedBlocks();f.length && (d = e.getAttrib(f[0], "dir"), b.each(f, function (a) {
          e.getParent(a.parentNode, "*[dir='" + c + "']", e.getRoot()) || (d != c ? e.setAttrib(a, "dir", c) : e.setAttrib(a, "dir", null));
        }), a.nodeChanged());
      }function d(a) {
        var c = [];return b.each("h1 h2 h3 h4 h5 h6 div p".split(" "), function (b) {
          c.push(b + "[dir=" + a + "]");
        }), c.join(",");
        ...
        c("rtl");
      }), a.addButton("ltr", { title: "Left to right", cmd: "mceDirectionLTR", stateSelector: d("ltr") }), a.addButton("rtl", { title: "Right to left", cmd: "mceDirectionRTL", stateSelector: d("rtl") });
    }), function () {};
  }), d("0")();
}();