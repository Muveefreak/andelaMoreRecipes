    ...
    return a.add("nonbreaking", function (a) {
      var b = a.getParam("nonbreaking_force_tab"),
        ...
        for (var c = "", d = 0; d < b; d++) {
          ...
          d = function d(b) {
        var d = a.plugins.visualchars && a.plugins.visualchars.state ? '<span class="mce-nbsp">&nbsp;</span>' : "&nbsp;";a.insertContent(c(d, b)), a.dom.setAttrib(a.dom.select("span.mce-nbsp"), "data-mce-bogus", "1");
        ...
        var e = +b > 1 ? +b : 3;a.on("keydown", function (a) {
          if (9 == a.keyCode) {
            if (a.shiftKey) return;a.preventDefault(), d(e);
          }
        });
      }
    }), function () {};
