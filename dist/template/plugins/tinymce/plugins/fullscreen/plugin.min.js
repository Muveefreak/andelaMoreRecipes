...
!function () {
  var a = {},
    ...
    var c = a.DOM;return b.add("fullscreen", function (a) {
      function b() {
        var a,
            b,
            c = window,
        ...
        var a = c.getViewPort();return { x: a.x, y: a.y };
      }function e(a) {
        ...
        function f() {
          ...
          k,
          l,
          m = !1;if (!a.settings.inline) return a.on("init", function () {
        a.addShortcut("Ctrl+Shift+F", "", f);
      }), a.on("remove", function () {
        i && c.unbind(window, "resize", i);
      }), a.addCommand("mceFullScreen", f), a.addMenuItem("fullscreen", { text: "Fullscreen", shortcut: "Ctrl+Shift+F", selectable: !0, onClick: function onClick() {
          f(), a.focus();
        }, onPostRender: function onPostRender() {
          var b = this;a.on("FullscreenStateChanged", function (a) {
            b.active(a.state);
          });
        }, context: "view" }), a.addButton("fullscreen", { tooltip: "Fullscreen", shortcut: "Ctrl+Shift+F", onClick: f, onPostRender: function onPostRender() {
          var b = this;a.on("FullscreenStateChanged", function (a) {
            b.active(a.state);
          });
